    ...
    return (
        ...
        <div className="mx-auto flex max-w-5xl items-center justify-center">
            ...
            <CardContent className="flex flex-col items-center px-6 py-12 text-center md:px-12 md:py-16">
                ...
                <h1 className="mt-4 text-4xl font-black tracking-tight text-fuchsia-blue-100 md:text-5xl">
                Bem-vindo à comunidade Huddle!
                </h1>

                <p className="mt-5 max-w-xl text-base leading-relaxed text-fuchsia-blue-300 md:text-lg">
                ...
                <h2 className="text-lg font-bold  text-fuchsia-blue-200">
                    Como foi sua experiência de cadastro?
                </h2>

                <p className="mt-2 text-sm text-fuchsia-blue-300">
                ...
                {avaliacao > 0 && (
                    <p className="mt-4 text-sm font-medium  text-fuchsia-blue-200">
