...
export function HuddleContent() {
  ...
  // Verifica se tem perfis, se não tiver, retorna uma imagem diferente
  ...
  "
                  ...
                  <div className="p-7">
                    ...
                    <div>
                      {/* ===== "Jogo preferido" + contador de afinidade ===== */}
                    ...
                    <div className="mt-6 grid gap-3.5 sm:grid-cols-2">
                      <div className="flex min-h-19 items-center gap-3 rounded-2xl border border-fuchsia-blue-200/70 bg-white/55 px-4 py-3.5 dark:border-border dark:bg-muted/45">
                        ...
                        {mesmoGameplay ? (
                          <Check
                            className="ml-auto size-4 shrink-0 text-cyan-600 dark:text-cyan-300"
                            strokeWidth={3}
                          />
                        ) : (
                      ...
                      {/* ===== SÍMBOLO DE SINERGIA ===== */}
                      <div
                        className={`relative flex min-h-19 items-center justify-center gap-3 overflow-hidden rounded-2xl border px-4 py-3.5 ${tierInfo.borda}`}
                      >
                        <div
                        ...
                        <Hexagon
                          ...
                          aria-hidden="true"
                        />
                        <span className={`${smfontClass} bg-linear-to-r ${tierInfo.tituloCor} bg-clip-text font-black uppercase tracking-[0.15em] text-transparent`}>{tierInfo.titulo}</span>
                      </div>
                    </div>
                  </div>
                </motion.article>
