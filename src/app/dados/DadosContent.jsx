...
export function DadosContent() {
    const { XlfontClass, Xl3fontClass, Xl4fontClass, xl5fontClass, Xl6fontClass, smfontClass, sm2fontClass, XsfontClass, lgfontClass } = useFontSize();
    return (
        <main className="min-h-screen bg-linear-to-b from-fuchsia-blue-600 via-fuchsia-blue-50 to-white px-4 py-14 text-foreground dark:from-fuchsia-blue-600 dark:via-fuchsia-blue-950 dark:to-background">
            <div className="mx-auto max-w-362.5 space-y-24">
                <section className="text-center">
                    ...
                    <p className={`mx-auto mt-4 max-w-3xl ${lgfontClass}  text-fuschia-blue-100`}>
                                        ...
                                        <div className="h-full">
                                            <div className="flex h-107.5 flex-col justify-between rounded-[2rem] bg-fuchsia-blue-700 p-7 text-white shadow-xl ring-1 ring-fuchsia-blue-300/20">
                                                <div>
                                                    ...
                                                    <p className={`mt-6 max-w-[15ch] ${XlfontClass}  dark:text-fuchsia-blue-100`}>
                                                        {card.text}
                                                    </p>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <p className={`${XsfontClass} uppercase tracking-[0.2em] text-white/60`}>
                ...
                <section className="text-center">
                    ...
                    <p className={`mx-auto mt-4 max-w-3xl ${lgfontClass} leading-relaxed text-fuchsia-blue-950 dark:text-fuchsia-blue-100 text`}>
                ...
                <section className="overflow-hidden rounded-[2rem] border border-fuchsia-blue-200 bg-linear-to-br from-white via-fuchsia-blue-50/40 to-white shadow-[0_10px_40px_rgba(93,63,194,0.08)] dark:border-fuchsia-blue-900 dark:from-fuchsia-blue-950/30 dark:via-card dark:to-background">
                    <div className="border-b border-fuchsia-blue-100 px-6 py-6 dark:border-fuchsia-blue-900 md:px-8">
                        <p className={`${smfontClass} font-bold uppercase tracking-[0.25em] text-fuchsia-blue-600`}>
                            Comparativo
                        </p>

                        <h3 className={`mt-2 ${Xl3fontClass} font-black text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}>
                            Benchmark
                        </h3>

                        <p className={`mt-3 max-w-3xl ${sm2fontClass} leading-relaxed text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {benchmarkData.map((item) => (
                                    ...
                                    >
                                        <TableCell className={`font-semibold ${lgfontClass} text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}>
                                            {item.plataforma}
                                        </TableCell>

                                        <TableCell className={`leading-relaxed ${lgfontClass} text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}>
                                            {item.foco}
                                        </TableCell>
