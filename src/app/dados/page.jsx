    ...
    return (
        <main className="min-h-screen bg-white px-4 py-16 text-foreground dark:bg-background">
        <div className="mx-auto max-w-362.5 space-y-24">
            ...
            <h1 className="mt-3 text-4xl font-black tracking-tight text-fuchsia-blue-950 dark:text-fuchsia-blue-100 md:text-6xl">
                Os números{" "}
                <span className="bg-linear-to-r from-fuchsia-blue-700 via-fuchsia-blue-500 to-fuchsia-blue-300 bg-clip-text text-transparent">
                dizem tudo
                </span>
            </h1>
            ...
            <p className="mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-muted-foreground md:text-base">
                ...
                jogadores enfrentam hoje — e por que estamos construindo uma forma
            ...
            <div className="mx-auto max-w-6xl px-8">
                ...
                <CarouselContent className="-ml-5">
                    ...
                    >
                        ...
                        <div className="flex h-107.5 flex-col justify-between rounded-[2rem] bg-linear-to-br from-fuchsia-blue-700 via-fuchsia-blue-800 to-fuchsia-blue-950 p-7 text-white shadow-xl ring-1 ring-fuchsia-blue-300/20">
                            <div>
                            <p className="text-5xl font-black leading-none md:text-6xl">
                                {card.number}
                            </p>

                            <p className="mt-6 max-w-[15ch] text-2xl leading-tight text-white/90">
                                {card.text}
                            </p>
                            </div>
            ...
            <div className="p-4 sm:p-6 md:p-8">
                ...
                <TableBody>
                    ...
                    >
                        <TableCell className="font-semibold text-fuchsia-blue-950 dark:text-fuchsia-blue-100">
                        {item.plataforma}
                        </TableCell>

                        <TableCell className="leading-relaxed text-muted-foreground">
                        {item.foco}
                        </TableCell>
