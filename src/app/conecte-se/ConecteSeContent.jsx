...
export function ConecteSeContent() {
    ...
    const { XlfontClass, Xl5fontClass, smfontClass, sm2fontClass } = useFontSize();
        ...
        <main className="min-h-screen bg-linear-to-b from-fuchsia-blue-600 via-fuchsia-blue-50 to-white px-4 py-14 text-foreground dark:from-fuchsia-blue-600 dark:via-fuchsia-blue-950 dark:to-background">
            <div className="mx-auto max-w-5xl space-y-10">
                <section className="text-center">
                    <p className={`${XlfontClass} font-bold uppercase tracking-[0.25em] text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}>
                        Cadastro
                    </p>

                    <h1 className={`mt-3 ${Xl5fontClass} font-black tracking-tight text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}>
                ...
                <Card className="mx-auto max-w-3xl overflow-hidden border border-fuchsia-blue-300 bg-white/95 shadow-xl dark:border-fuchsia-blue-600 dark:bg-fuchsia-blue-950/40 dark:shadow-none">
                    <CardContent className="p-6 md:p-10">
                        <form onSubmit={enviarFormulario} noValidate className="space-y-7">
                            ...
                            <div className="space-y-2">
                                <Label className={`text-fuchsia-blue-950 dark:text-fuchsia-blue-100 ${XlfontClass}`}>
                                    Tipo de gameplay
                                </Label>
                                ...
                                <Select value={gameplay} onValueChange={setGameplay}>
                                    ...
                                    <SelectContent side="bottom" align="start" position="popper">
                                        {playstyles.map((playstyle) => (
                                            <SelectItem key={playstyle.id} value={playstyle.name} className={XlfontClass}> {playstyle.name}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                                </Select>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select className="w-1xl" value={selectedGame} onValueChange={setSelectedGame}>
                                    ...
                                    <SelectContent side="bottom" align="start" position="popper">
                                        {games.map((game) => (
                                            <SelectItem key={game.id} value={game.name} className={XlfontClass}> {game.name}
                                            </SelectItem>
                                        ))}
                                    </SelectContent>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-3 sm:grid-cols-2">
                                    <label className={`flex items-center gap-3 rounded-2xl border border-fuchsia-blue-200 bg-fuchsia-blue-50 p-3 ${XlfontClass} font-medium text-fuchsia-blue-950 dark:border-fuchsia-blue-900 dark:bg-background dark:text-fuchsia-blue-100 `}>
                                        <Checkbox checked={horarios.manha} onCheckedChange={(val) => handleCheckboxChange('manha', val)} />
                                        Manhã
                                    </label>

                                    <label className={`flex items-center gap-3 rounded-2xl border border-fuchsia-blue-200 bg-fuchsia-blue-50 p-3 ${XlfontClass} font-medium text-fuchsia-blue-950 dark:border-fuchsia-blue-900 dark:bg-background dark:text-fuchsia-blue-100`}>
                                        <Checkbox checked={horarios.tarde} onCheckedChange={(val) => handleCheckboxChange('tarde', val)} />
                                        Tarde
                                    </label>

                                    <label className={`flex items-center gap-3 rounded-2xl border border-fuchsia-blue-200 bg-fuchsia-blue-50 p-3 ${XlfontClass} font-medium text-fuchsia-blue-950 dark:border-fuchsia-blue-900 dark:bg-background dark:text-fuchsia-blue-100`}>
                                        <Checkbox checked={horarios.noite} onCheckedChange={(val) => handleCheckboxChange('noite', val)} />
                                        Noite
                                    </label>

                                    <label className={`flex items-center gap-3 rounded-2xl border border-fuchsia-blue-200 bg-fuchsia-blue-50 p-3 ${XlfontClass} font-medium text-fuchsia-blue-950 dark:border-fuchsia-blue-900 dark:bg-background dark:text-fuchsia-blue-100`}>
                                        <Checkbox checked={horarios.fimDeSemana} onCheckedChange={(val) => handleCheckboxChange('fimDeSemana', val)} />
                                        Fins de semana
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="grid gap-3 sm:grid-cols-2">
                                <Button
                                    type="submit"
                                    className={`h-12 rounded-full bg-fuchsia-blue-600 text-white hover:bg-fuchsia-blue-700 ${XlfontClass}`}
                                >
                                    Participar
                                </Button>
                                ...
                                <Button
                                    type="button"
                                    variant="outline"
                                    className={`h-12 rounded-full border-fuchsia-blue-300 dark:text-fuchsia-blue-100 text-fuchsia-blue-700 dark:hover:bg-fuchsia-blue-700 hover:bg-fuchsia-blue-700 hover:text-white ${XlfontClass} bg-background-white`}
                                    asChild
                                >
