    ...
    <main className="min-h-screen bg-linear-to-b from-fuchsia-blue-600 via-fuchsia-blue-50 to-white px-4 py-14 text-foreground dark:from-fuchsia-blue-600 dark:via-fuchsia-blue-950 dark:to-background">
      <div className="mx-auto max-w-5xl space-y-10">
        <section className="text-center">
          ...
          <h1
            className={`mt-3 ${Xl5fontClass} font-black tracking-tight text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}
          >
                ...
                <div className="space-y-2">
                  ...
                  {erros.cpf && (
                    <div>
                      ...
                      <p
                        className={`${smfontClass} font-medium text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}
                      >
