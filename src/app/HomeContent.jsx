      ...
      <div className="mx-auto max-w-1450px space-y-20">
          ...
          <div className="relative min-h-620px overflow-hidden">
            ...
            <div className="relative z-10 flex min-h-620px items-center px-6 py-12 md:px-12 lg:px-16">
              <div className="max-w-2xl">
                <p className={`${XlfontClass} font-bold uppercase tracking-[0.25em] text-fuchsia-blue-300`}>
                ...
                <p className={`mt-6 max-w-xl ${XlfontClass} leading-relaxed text-white/80`}>
                ...
                <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                  <Link
                    href="/conecte-se"
                    className={`rounded-full bg-white px-6 py-3 text-center ${smfontClass} font-bold text-fuchsia-blue-950 transition-colors hover:bg-fuchsia-blue-100`}
                  >
                    Começar agora
                  </Link>
        ...
        <section className="grid gap-5 md:grid-cols-3">
          <article className="rounded-[2rem] border border-fuchsia-blue-200 bg-linear-to-br from-white via-fuchsia-blue-50 to-white p-6 shadow-[0_10px_40px_rgba(93,63,194,0.08)] dark:border-fuchsia-blue-900 dark:from-fuchsia-blue-950/30 dark:via-card dark:to-background">
            <p className={`${smfontClass} font-bold uppercase tracking-[0.2em] text-fuchsia-blue-600`}>
              Afinidade
            </p>

            <h2 className={`mt-3 ${XlfontClass} font-black text-fuchsia-blue-950 dark:text-fuchsia-blue-100`}>
              Conexões que fazem sentido
            </h2>

            <p className={`mt-3 ${lgfontClass} leading-relaxed dark:text-white`}>
